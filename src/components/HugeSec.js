...
import "../css/HugeSec.scss";
const HugeSec = () => {
  return (
    <div className="bg-huge pb-5">
      <div className="container">
        <h1 className="text-white pt-5 display-4 fw-bold heading-huge">
          Let's Tell Huge Stories Together
        </h1>
        <div className=" text-white pt-3 text-huge">
        ...
        <div className="startnow btn mt-4 ">
          <a href="#">Start now</a>
        </div>
      </div>
    </div>
